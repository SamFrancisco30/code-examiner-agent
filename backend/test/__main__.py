...
from backend.agent_service.redis_node import redis_load_node, redis_merge_node, redis_save_node, redis_delete_node
...
#         publish(json.dumps(event_data), 'init_queue')
#
#     start_redis_listener()
#     listener = create_listener(queue_name="llm_prompt", input_able=False)
#
#     while True:
...
if __name__ == "__main__":
    ...
    # 启动消息队列监听线程
    # for i in test_state_edit:
    #     publish(i, i['event_type'])
    #     time.sleep(5)
    # time.sleep(5)
    i = {
        "user_id": "123456",
